...
If you want to create interactive games using the micro:bit try out 'Interactive badge', the first project in the BBC micro:bit module. There’s also plenty of other modules to try!
